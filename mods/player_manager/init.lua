...
core.register_entity("player_manager:npc_builder", {
  ...
  on_activate = function(self, staticdata, dtime_s)
    ...
    local inv_size = 8
    local props = {name_ = "FocusNPC824"}
    self.inv = core.get_inventory({type="detached", name="npc_builder_" .. props.name_})
  ...
  on_rightclick = function(self, clicker)
    core.chat_send_player(clicker:get_player_name(), "Hi, I'm "..self:get_properties().name_)
   end,
  on_attach_child = function(self, child) end,
  on_detach_child = function(self, child) end,
  on_detach = function(self, parent) end,
